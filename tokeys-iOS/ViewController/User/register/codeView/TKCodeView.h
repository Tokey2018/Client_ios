...
typedef NS_ENUM(NSInteger,TKCodeViewType) {
    TKCodeViewTypeCustom,//普通样式
    TKCodeViewTypeSecret//密码风格
};
@interface TKCodeView : UIView
//输入完成回调
@property (nonatomic, copy) void(^EndEditBlcok)(NSString *text);

//样式
@property (nonatomic, assign) TKCodeViewType codeType;
